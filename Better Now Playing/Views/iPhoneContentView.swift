...
//    var spotifyDelegateWrapper = SpotifyManagerDelegateWrapper()
    
    let viewModel = ProgramViewModel(connectivityManager: ConnectivityManager())
    let connect = ConnectivityManager()

    init() {
//         spotifyDelegateWrapper.sendChangeHandler = { [self] in
//             self.sendChange()
//         }
//         spotifyPlayer.delegate = spotifyDelegateWrapper
//        let sendChangeHandler = { [sendChange] in
//            sendChange()
//        }
//        spotifyDelegateWrapper.sendChangeHandler = sendChangeHandler
//        spotifyPlayer.delegate = spotifyDelegateWrapper
    }
